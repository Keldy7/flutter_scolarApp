class Routes {
  ...
  static String ecoleDetailScreenRoute = "keyEcoleDetailScreenRoute";
  static String childrenScreenRoute = "keyChildrenScreenRoute";
  ...
  static String chatScreenRoute = "keyChatScreenRoute";
